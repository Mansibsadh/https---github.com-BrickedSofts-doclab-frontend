          ...
          <div class="row">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary">Neurologist</h4>
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> Dentist</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary">Physiotherapists</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> Surgeon</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> Orthopedist</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> pediatrician</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> General physician</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> Gastroentrologist</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> Dietitian</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> E.N.T</h4>
                  <p class="card-text text-secondary">
            ...
            <div class="col-sm-4 mb-5">
              <div class="card mt-4">
                ...
                <div class="card-body">
                  <h4 class="card-title text-secondary"> Dermatologist</h4>
                  <p class="card-text text-secondary">
